...
- Treat `AGENTS.md` as the always-on project rulebook. `AGENTS.md` should be a hard link to `AGENTS.md`; if project rules change, update `AGENTS.md` and the relevant `.codex/skills/*/SKILL.md` together.
