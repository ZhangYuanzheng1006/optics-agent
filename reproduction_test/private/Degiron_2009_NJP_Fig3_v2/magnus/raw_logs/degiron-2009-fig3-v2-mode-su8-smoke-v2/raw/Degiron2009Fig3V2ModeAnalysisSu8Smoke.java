...
public class Degiron2009Fig3V2ModeAnalysisSu8Smoke {
  ...
  private static void buildExplicitMesh(Model model) throws Exception {
    model.mesh().create("mesh1", "geom1");
    model.mesh("mesh1").automatic(false);
    try { model.mesh("mesh1").feature().clear(); } catch (Throwable ignored) {}
    model.mesh("mesh1").feature().create("size1", "Size");
    model.mesh("mesh1").feature("size1").set("hmax", "0.20[um]");
    model.mesh("mesh1").feature("size1").set("hmin", "0.02[um]");
